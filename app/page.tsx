...
export default function Home() {
  ...
  const events = [
    ...
    {
      id: 2,
      title: "Điểm tâm trưa cùng đối tác",
      startTime: "12:30",
      endTime: "13:30",
      color: "bg-green-500",
      day: 1,
    ...
    {
      id: 4,
      title: "Gọi khách hàng để đề xuất",
      startTime: "10:00",
      endTime: "11:00",
      color: "bg-yellow-500",
      day: 2,
    ...
    {
      id: 5,
      title: "Tổng hợp báo cáo tài chính",
      startTime: "13:00",
      endTime: "14:30",
      color: "bg-indigo-500",
      day: 4,
    ...
    {
      id: 6,
      title: "Tổng hợp báo cáo cho nhà đầu tư",
      startTime: "11:00",
      endTime: "12:00",
      color: "bg-pink-500",
      day: 5,
    ...
    {
      id: 14,
      title: "Trình bày dự án với khách hàng",
      startTime: "11:00",
      endTime: "12:30",
      color: "bg-orange-400",
      day: 6,
  ...
  const timeSlots = Array.from({ length: 24 }, (_, i) => i ) // 8 AM to 4 PM
    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <main className="relative h-screen w-full pt-20 flex">
        ...
        >
          ...
          {/* Week View */}
          <div className="flex-1 overflow-auto p-4 bg-white/20 backdrop-blur-lg  border border-white/20 shadow-xl">
